...
import { InstitutionalTrustStrip } from "@/components/layout/institutional-trust-strip";
import { Navbar } from "@/components/layout/navbar";

type PageShellProps = {
  children: React.ReactNode;
  stickyCta?: React.ReactNode;
  showInstitutionalTrustStrip?: boolean;
};

export function PageShell({
  children,
  stickyCta,
  showInstitutionalTrustStrip = true,
}: PageShellProps) {
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      {stickyCta}
      {showInstitutionalTrustStrip ? <InstitutionalTrustStrip /> : null}
      <Footer />
    </div>
  );
}
